...
| artifact-catalog | 1 | 발행한 클로드 아티팩트의 **볼트별 누적 등록부**(`claude/artifact/catalog.json`) + 프로젝트별 섹션·검색 카탈로그 페이지. `Artifact list` 50건 창 밖으로 밀린 것을 지킨다. **페이지 = 볼트 하나** — 회사·개인은 설정 구조상 한 페이지에 못 섞인다. v0.1.0 (2026-09-18) |
