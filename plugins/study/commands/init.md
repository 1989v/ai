...
study/temp.md에 기록된 스터디 주제를 읽고, 구조화된 학습 계획서를 `study/docs/{N}-{slug}/00-plan.md`에 생성한다.
...
2. `study/docs/` 하위의 **주제 폴더** 목록을 스캔 (Glob: `study/docs/*/00-plan.md`)
...
**파일 경로**: `study/docs/{N}-{slug}/00-plan.md`
...
- 계획서 경로: `study/docs/{N}-{slug}/00-plan.md`
- 학습 목표 요약 (3줄 이내)
- 예상 난이도 + 학습 시간
...
- `study/docs/` 없음: 자동 생성
- 이미 `{N}-{slug}/00-plan.md` 존재: 덮어쓰기 여부 확인
