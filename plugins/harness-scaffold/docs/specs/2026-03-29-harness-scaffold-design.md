...
어떤 프로젝트든 `/harness-scaffold:init` 한 번으로 성숙한 AI 하네스 환경을 구축하는 범용 Claude Code 플러그인.
...
`/harness-scaffold:init` 셋업 시 선택. **기본값: 품질 모드**.
...
커맨드 실행 시 일시 오버라이드 가능: `/harness-scaffold:verify --mode efficient`
...
├── commands/
│   ├── init.md                  # /harness-scaffold:init
│   ├── shape-spec.md            # /harness-scaffold:shape-spec
│   ├── write-spec.md            # /harness-scaffold:write-spec
│   ├── create-tasks.md          # /harness-scaffold:create-tasks
│   ├── implement-tasks.md       # /harness-scaffold:implement-tasks
│   ├── orchestrate-tasks.md     # /harness-scaffold:orchestrate-tasks
│   ├── drift-check.md           # /harness-scaffold:drift-check
│   ├── interview-capture.md     # /harness-scaffold:interview-capture
│   ├── verify.md                # /harness-scaffold:verify
│   └── spec-review.md           # /harness-scaffold:spec-review
├── skills/
│   ├── core/
...
## 3. `/harness-scaffold:init` — 자동 스캔 + 대화형 셋업
...
```
/harness-scaffold:shape-spec ──→ /harness-scaffold:write-spec ──→ /harness-scaffold:create-tasks
       │                                         │
       │         /harness-scaffold:interview-capture          │
       │         (구현 전 게이트)                    │
       │                ↓                         ↓
       │         /harness-scaffold:implement-tasks ←──── /harness-scaffold:orchestrate-tasks
       │                │
       │         /harness-scaffold:verify
       │                │
       └──────── /harness-scaffold:drift-check (언제든 실행 가능)
```

### 커맨드 상세

#### `/harness-scaffold:shape-spec` — 요구사항 수집
...
#### `/harness-scaffold:write-spec` — 스펙 작성
...
#### `/harness-scaffold:implement-tasks` — 구현
...
#### `/harness-scaffold:drift-check` — 4렌즈 불일치 감지
...
#### `/harness-scaffold:spec-review` — 스펙 리뷰
