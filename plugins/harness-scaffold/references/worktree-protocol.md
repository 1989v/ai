...
Use this protocol when worktree isolation is enabled in /harness-scaffold:implement-tasks or /harness-scaffold:orchestrate-tasks.
...
To fix:
- Run /harness-scaffold:init first to set up parallel execution
...
For /harness-scaffold:orchestrate-tasks with `execution: parallel`:
