...
│   └── src/main/kotlin/{{base_package_path}}/{service}/
│       └── domain/
│           └── {entity}/
...
|---|---|
| `product/product/controller/` | `{{base_package}}.product.presentation.product.controller` |
| `product/product/service/` | `{{base_package}}.product.application.product.service` |
| `product/persistence/product/adapter/` | `{{base_package}}.product.infrastructure.persistence.product.adapter` |
