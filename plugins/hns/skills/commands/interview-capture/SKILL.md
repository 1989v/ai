...
- **Terminology drift**: Does the spec use any term that conflicts with `docs/product/glossary.md`? Any new term coined without entry? — if found, recommend `/hns:glossary --conflict {term}` before proceeding
...
1. Load `docs/product/glossary.md` (if exists)
