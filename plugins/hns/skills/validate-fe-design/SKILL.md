---
name: validate-fe-design
description: Use to validate frontend code against the project's design guardrails — AI-slop patterns, typography, color, layout, motion, and accessibility — with a scored report.
when_to_use: FE 디자인 검증, AI slop, 디자인 컨벤션 확인, design lint
argument-hint: "[--target name] [--auto-only] [--fix]"
---
...
- **Called by**: hns:start PHASE 7 (FE 프로젝트인 경우) · 사용자 직접
