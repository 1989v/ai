---
name: health-mode
description: Use to view or change the docs-health CI workflow mode (full / diagnose / off) via the HNS_DOCS_HEALTH_MODE repository variable.
when_to_use: 비용 모드 변경, 워크플로 끄기, 워크플로 모드, health mode, cost switch
disable-model-invocation: true
argument-hint: "[full|diagnose|off] [--repo owner/repo]"
---
