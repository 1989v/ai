---
name: glossary
description: Use to build or evolve the project's domain glossary (ubiquitous language) — 8-source deep analysis classifying terms into Aggregate / Entity / VO / Service / Event / Policy / Port with quality gates; also resolves term conflicts.
when_to_use: 유비쿼터스 언어, 용어 사전, 도메인 사전, glossary, 용어 정리, 용어 충돌
argument-hint: "[--deep|--shallow] [--conflict term] [--review] [--bc name]"
---
...
## Procedure
실제 절차는 같은 폴더의 [procedure.md](procedure.md). 요약:
